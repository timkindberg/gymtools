...
export const PROGRAM = {
  ...
  days: [
    // ---------------------------------------------------------------- MONDAY
    {
      ...
      exercises: [
        ex({
          id: "a1", name: "Barbell Box Squat", target: "Quads / glutes",
        ...
        ex({
          id: "a2", name: "Barbell Bench Press", target: "Chest / triceps / shoulders",
        ...
        ex({
          id: "a4", name: "DB Reverse Lunge", target: "Unilateral legs",
    ...
    // ---------------------------------------------------------------- WEDNESDAY
    {
      ...
      exercises: [
        ex({
          id: "b1", name: "Barbell Romanian Deadlift", target: "Hamstrings / glutes / back",
        ...
        ex({
          id: "b2", name: "Pull-up / Lat Pulldown", target: "Lats / upper back",
        ...
        ex({
          id: "b3", name: "Barbell or DB Incline Press", target: "Upper chest / shoulders",
          sets: 3, reps: "6–10", rpe: "8", rest: "90s", flags: ["shoulder"], ss: "S1",
          why: "A low incline hits the shoulder-safe pressing angle and adds upper-chest without going overhead. Non-competing superset with the pulldown.",
    ...
    // ---------------------------------------------------------------- FRIDAY
    {
      ...
      exercises: [
        ex({
          id: "c1", name: "Barbell Hip Thrust", target: "Glutes",
        ...
        ex({
          id: "c2", name: "DB Lateral Lunge", target: "Adductors / frontal plane",
        ...
        ex({
          id: "c4", name: "Single-Leg DB RDL", target: "Unilateral hinge / balance",
